  ...
  return (
    <div className={`${ darkMode ? 'bg-dark' : 'bg-light'} sidebar myBrad col-3 ms-5 d-xl-block d-none`}>
      <div className="d-flex justify-content-center mt-5">
        <div className="myBrad overflow-hidden">
          <img
      ...
      <ul>
        <li className="d-flex py-3">
          <i className="bi bi-envelope py-2 px-3 myBrad shadow fs-5 me-3 myAlternate"></i>
          <div>
        ...
        <li className="d-flex py-3">
          <i className="bi bi-telephone py-2 px-3 myBrad shadow me-3 myAlternate fs-5"></i>
          <div>
        ...
        <li className="d-flex py-3">
          <i className="bi bi-calendar-event py-2 px-3 myBrad shadow me-3 myAlternate fs-5"></i>
          <div>
        ...
        <li className="d-flex align-items-center py-3">
          <i className="bi bi-house py-2 px-3 myBrad shadow me-3 myAlternate fs-5"></i>
          <div>
